  ...
  return (
    <section className="relative min-h-[80vh] sm:min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-40 sm:w-80 h-40 sm:h-80 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 mb-6 sm:mb-8">
            ...
            <h1 className="font-display text-3xl sm:text-5xl lg:text-7xl font-bold leading-tight mb-4 sm:mb-6 px-2">
              ...
              <span className="text-gradient-accent">{t("hero.getInvestment2")}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4 sm:px-0">
              <Button
                size="lg"
                className="rounded-full text-sm sm:text-base px-6 sm:px-8 h-12 btn-glow hover:brightness-110 transition-all w-full sm:w-auto"
                asChild
              >
                <Link to="/signup">
              ...
              <Button
                size="lg"
                variant="outline"
                className="rounded-full text-sm sm:text-base px-6 sm:px-8 h-12 border-border hover:border-primary/50 w-full sm:w-auto"
                asChild
              >
