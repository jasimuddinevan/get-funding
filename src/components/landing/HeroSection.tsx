        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-primary/30 bg-primary/10 mb-8">
              ...
              <span className="text-xs font-medium text-primary">Revenue Sharing Investment Platform</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              Connect with verified businesses, invest through transparent revenue sharing, 
              and grow your wealth — from Bangladesh to the world.
            </p>
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm">
              <TrendingUp className="w-4 h-4 text-primary" />
              <span>Revenue Based Returns</span>
            </div>
            <div className="w-px h-4 bg-border hidden sm:block" />
            <div className="flex items-center gap-2 text-sm">
              <span>🇧🇩</span>
              <span>BD & Global Markets</span>
            </div>
          </motion.div>
        </div>
      </div>
