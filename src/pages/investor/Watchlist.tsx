...
import { Bookmark, MapPin, TrendingUp, Trash2, Heart } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Businesses you're keeping an eye on.</p>
      </div>
        ...
        <CardContent>
          {items.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-xs text-muted-foreground mt-1 mb-4">Save businesses you're interested in to track them here.</p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h4 className="font-semibold text-foreground text-sm">{biz?.name ?? "Unknown"}</h4>
